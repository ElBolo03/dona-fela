...
const productos = [
  ...
  imagen: "public/productos/ecoflow-delta-3-classic.jpg",
    emoji: "🔋",
  },
  {
    ...
    precio: "$85",
    descripcion: "Bicicleta infantil con accesorios.",
    emoji: "🚲",
  },
  {
    nombre: "Televisor",
    ...
    precio: "$155",
    descripcion: "Televisor disponible. Pregunta por modelos.",
    emoji: "📺",
  },
  {
    nombre: "Olla Arrocera 2.2 L",
    categoria: "Electrodomésticos para su hogar",
    precio: "$155",
        ...
        <div className="mx-auto max-w-6xl px-5 py-5">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-100">Tu tienda de confianza</p>
            </div>
